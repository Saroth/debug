...
#define DBG_LABEL_COLOR     ( 1 << 1 )          //!< 颜色显示,需要DBG_USE_COLOR
#define DBG_LABEL_STDERR    ( 1 << 2 )          //!< 显示错误信息
#define DBG_LABEL_NEWLINE   ( 1 << 3 )          //!< 添加换行符
#define DBG_LABEL_INFO      ( 1 << 4 )          //!< 添加提示标记
#define DBG_LABEL_WARN      ( 1 << 5 )          //!< 添加警告标记
#define DBG_LABEL_ERR       ( 1 << 6 )          //!< 添加错误标记
